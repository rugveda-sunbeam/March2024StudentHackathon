...
public class Blog {
	...
	public Blog(int id, String title, String contents, int user_id, int category_id,
			String filename) {
		super();
		this.id = id;
		this.title = title;
	...
	public Blog(int id, String title, Date created_time, int user_id, int category_id, String filename) {
		super();
		this.id = id;
		this.title = title;
